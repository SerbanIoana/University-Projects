...
from domain.utils import WHITE
...
def mapWithDrone(currentMap):
    # create empty white screen
    screen = initPyGame((currentMap.n * 20, currentMap.m * 20))
    # put the image of the map
    screen.blit(image(currentMap), (0, 0))
    # put the drone on the map
    drone = (currentMap.droneX, currentMap.droneY)
    droneImg = pygame.image.load("drona.png")
    screen.blit(droneImg, (drone[1] * 20, drone[0] * 20))
