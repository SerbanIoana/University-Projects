...
public class Interpreter {
    public static void main(String[] args) {
        ...
        exHAllocation.typecheck(new MyDict<>());
        ...
        exHReading.typecheck(new MyDict<>());
        ...
        exHWriting.typecheck(new MyDict<>());
        ...
        exGarbageCollector.typecheck(new MyDict<>());
