    ...
    public IDict<String, IType> typecheck(IDict<String, IType> typeEnv) throws MyException {
        ...
        if (exp_Type.equals(new StringType()))
            if (var_type.equals(new IntType()))
                ...
                throw new MyException("Typecheck error: ReadFileStmt variable is not an integer!");
        else
            throw new MyException("Typecheck error: ReadFileStmt expression is not a string!");
    }
}
